...
save_general_log() {
	...
	#fi
        ...
        cp -r /data/media/0/logs/aplog/kernel* $GENERAL_LOG/
        cp -r /data/media/0/logs/aplog/event* $GENERAL_LOG/
        cp -avrf /data/media/0/logs/aplog/last/* $GENERAL_LOG/last/
        cp -avrf /data/media/0/logs/aplog/last2/* $GENERAL_LOG/last2/
	...
	# save dumpstate report
        ...
        #    rm $filename
        #done
        cp -avf $BUGREPORT_PATH/* $GENERAL_LOG/
        rm -rf $BUGREPORT_PATH/*
	# Save microp_dump
